...
``t_{\text{max}}`` = $(@bind tmax Slider(0.0u"ns":1.0u"ns":500.0u"ns", default=500.0u"ns", show_value=true))

``Δt`` = $(@bind dt Slider(0.0u"ns":0.01u"ns":3.0u"ns", default=0.01u"ns", show_value=true))
"""
